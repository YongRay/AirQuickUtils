...
public class AirScreen {
    ...
    public static WindowManager getWindowManager() {
        return (WindowManager)AirQuickUtils.getContext().getSystemService(Context.WINDOW_SERVICE);
    }
    ...
    public static Boolean isLessThan7Inches() {
        return AirQuickUtils.getContext().getResources().getBoolean(R.bool.airquickutils_isLessThan7Inches);
    }

    public static Boolean isBetween7And10Inches() {
        return AirQuickUtils.getContext().getResources().getBoolean(R.bool.airquickutils_isBetween7And10Inches);
    }

    public static Boolean is10Inches() {
        return AirQuickUtils.getContext().getResources().getBoolean(R.bool.airquickutils_is10Inches);
    }

    public static Boolean is10InchesLand() {
        Resources resources = AirQuickUtils.getContext().getResources();
        return resources.getBoolean(R.bool.airquickutils_is10Inches) && resources.getBoolean(R.bool.airquickutils_isOrientationLandscape);
    }
    ...
    public static Integer getSmallestScreenWidthDp() {
        Configuration config = AirQuickUtils.getContext().getResources().getConfiguration();
    ...
    public static String getScreenDensity() {
        String density = AirString.EMPTY;
        if (AirScreen.isLdpiDensity()) {
            density = LDPI_DENSITY_NAME;
        } else if (AirScreen.isMdpiDensity()) {
            density = MDPI_DENSITY_NAME;
        } else if (AirScreen.isHdpiDensity()) {
            density = HDPI_DENSITY_NAME;
        } else if (AirScreen.isXhdpiDensity()) {
            density = XHDPI_DENSITY_NAME;
        } else if (AirScreen.isTVdpiDensity()) {
            density = TVDPI_DENSITY_NAME;
        } else if (AirScreen.isXXhdpiDensity()) {
            density = XXHDPI_DENSITY_NAME;
        } else if (AirScreen.isXXXhdpiDensity()) {
    ...
    public static int convertDimenToPixel(int dimenResId) {
        return (int) AirQuickUtils.getContext().getResources().getDimension(dimenResId);
    }
    ...
    public static int deviceDPI() {
        return AirQuickUtils.getContext().getResources().getDisplayMetrics().densityDpi;
    }
    ...
    public static String deviceResolution() {
        DisplayMetrics metrics = AirQuickUtils.getContext().getResources().getDisplayMetrics();
