...
import yongbeom.utils.airquickutils.collections.Lists;
import yongbeom.utils.airquickutils.collections.Sets;
...
public class AirString {
    ...
    public static String getNotEmptyString(String text) {
        return AirString.isEmpty(text) ? null : text;
    }
