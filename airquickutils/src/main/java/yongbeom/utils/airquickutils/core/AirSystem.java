...
public class AirSystem {
    ...
    public static void navigateToActivityByClassName(Context context, String className) throws ClassNotFoundException {
        ...
        if (className != null) {
            try {
                ...
                AirQuickUtils.log.d("ClassNotFound", e);
            }
        }
    ...
    public static String getApplicationHashKey(String packageName) {
        ...
        String hash = "";
        try {
            PackageInfo info = AirQuickUtils.getContext().getPackageManager().getPackageInfo(packageName, PackageManager.GET_SIGNATURES);
            ...
            AirQuickUtils.log.e("NameNotFoundException");
        } catch (NoSuchAlgorithmException e) {
            AirQuickUtils.log.e("NoSuchAlgorithmException");
    ...
    public static void toast(String message) {
        ...
        Toast toast = Toast.makeText(AirQuickUtils.getContext(), message, Toast.LENGTH_SHORT);
        toast.show();
    }
    ...
    public static void sleep(int milliseconds) {
        ...
        try {
            ...
            AirQuickUtils.log.e("Interrupted exception", e);
        }
    }
    ...
    public static String getDeviceID() {
        return Settings.Secure.getString(AirQuickUtils.getContext().getContentResolver(), Settings.Secure.ANDROID_ID);
    }
     ...
     * Get device UUID
     *
     * @return e.g. 7dc53df5-703e-49b3-8670-b1c468f47f1f
     */
    ...
    public static void toggleKeyboard() {
        InputMethodManager imm = ((InputMethodManager) AirQuickUtils.getContext().getSystemService(Context.INPUT_METHOD_SERVICE));
    ...
    public static boolean isServiceRunning(Class<? extends Service> service) {
        ActivityManager manager = (ActivityManager) AirQuickUtils.getContext().getSystemService(Context.ACTIVITY_SERVICE);
    ...
    public static String getApplicationName() {
        Context context = AirQuickUtils.getContext();
    ...
    public static void hideSoftInput(View view) {
        ((InputMethodManager) AirQuickUtils.getContext().getSystemService(Context.INPUT_METHOD_SERVICE)).hideSoftInputFromWindow(
    ...
    public static String getNetworkOperatorName() {
        TelephonyManager manager = (TelephonyManager) AirQuickUtils.getContext().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static Integer getHeapSize() {
        return ((ActivityManager) AirQuickUtils.getContext().getSystemService(Context.ACTIVITY_SERVICE)).getMemoryClass();
    }
    ...
    public static String getDeviceName() {
        ...
        if ((model != null) && model.startsWith(manufacturer)) {
            return AirString.capitalize(model);
        } else if (manufacturer != null) {
            return AirString.capitalize(manufacturer) + " " + model;
        } else {
            return "Unknown";
        }
    }
    ...
    public static String getDeviceType() {
        if (AirScreen.is10Inches()) {
            return "10\" tablet";
        } else if (AirScreen.isBetween7And10Inches()) {
            return "7\" tablet";
        } else {
            return "phone";
        }
    ...
    public static boolean isIntentAvailable(Intent intent) {
        List<ResolveInfo> list = AirQuickUtils.getContext().getPackageManager().queryIntentActivities(intent,
